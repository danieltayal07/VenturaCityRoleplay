...
Config.PedCoords = vector4(-777.86, 341.95, 196.69, 267.69)   -- Create preview ped at these coordinates
Config.HiddenCoords = vector4(-779.0154, 326.1801, 196.0860, 91.0454) -- Hides your actual ped while you are in selection
Config.CamCoords = vector4(-774.93, 341.77, 197.00, 87.87)        -- Camera coordinates for character preview screen
